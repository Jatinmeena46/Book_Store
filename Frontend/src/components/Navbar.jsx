      ...
      <div className="navbar">
        ...
        <div className="navbar-end space-x-3">
          ...
          <div className="hidden md:block">
            <label className="flex items-center gap-2 border rounded-lg px-3 py-2 shadow-sm w-full max-w-sm">
              <svg
              ...
              <input
                ...
                required
                placeholder="Search"
                className="outline-none bg-transparent w-full  dark:bg-slate-900 dark:text-white"
              />
            </label>
          </div>
          <div>
